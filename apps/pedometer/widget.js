(() => {
    ...
    var activeSeconds = 15; //in how many seconds dou you have to reach 10 steps so that they are counted
    ...
    var intervalResetActive = 60000; //interval for timer to reset active, in ms
    ...
    function draw() {
      ...
      g.setFont("6x8", 1);
      g.drawString(" S-" + steps,this.x,this.y);
      g.drawString("SC-" + stepsCounted,this.x,this.y+10);
      if (active == 1) g.drawString("A",this.x,this.y+20);
    }
